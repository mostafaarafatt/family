...
@section('content')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0 text-primary">الصفحات الثابتة / اضافة الصفحة</h4>
        </div>
    ...
    <div class="row">
        ...
        <div class="">
            <form class="form-horizontal" method="POST" action="{{ route('addpagedone') }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control " id="title-ar"
                                                        placeholder="العنوان  عربي" name="ar[title]" value="">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="slug-ar"
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control " id="slug-ar"
                                                        placeholder="مقتطف عربي" name="ar[slug]"
                                                        value="">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="content-ar"
                                                    ...
                                                    عربي</label>
                                                <div class="col-sm-9">
                                                    <textarea class="form-control " id="content-ar" placeholder="المحتوى عربي" name="ar[content]"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="images-ar"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control " id="title-en"
                                                        placeholder="العنوان  English" name="en[title]" value="WHO ARE WE">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="slug-en"
                                            ...
                                            <div class="form-group row">
                                                <label for="content-en"
                                                    ...
                                                    English</label>
                                                <div class="col-sm-9">
                                                    <textarea class="form-control " id="content-en" placeholder="المحتوى English" name="en[content]">Content Written Here </textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="images-en"
