...
@section('content')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0 text-primary">@lang('edit member data')</h4>
        </div>
                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ route('members.update', $familyMember->id) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" id="inputName"
                                    value="{{ $familyMember->name }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="information" rows="2" placeholder="@lang('add additional information about member')" required>{{ $familyMember->information }}</textarea>
                            </div>
                        </div>
