        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">@lang('add picture')</h3>
                </div>
                <div class="card-body">
                    <form class="row g-3" method="POST" action="{{ route('storeslider') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-4">
                            <label for="validationDefault01" class="form-label">@lang('picture name')</label>
                            <input placeholder="@lang('enter picture name')" type="text" name="title" class="form-control"
                                value="" required>
                        ...
                        <div class="mb-3">
                            ...
                            <label class="form-label " for="inputImage">@lang('choose picture')</label>
