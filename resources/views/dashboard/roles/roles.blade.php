        ...
        <div class="page-leftheader">
            <div class="btn-list">
                @if (auth()->user()->hasPermission('roles-create'))
                    <a href="{{ route('roles.create') }}" class="btn btn-outline-primary"><i class="fe fe-plus"></i>
                        @lang('Add new role')</a>
                @else
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">@lang('All Roles')</div>
                </div>
                <div class="card-body">
                        ...
                        <table id="{{ app()->getLocale() == 'ar' ? 'mytable' : 'example-1' }}"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">@lang('role name')</th>
                                            ...
                                            {{-- <div class="btn-group mt-0 mb-0">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    @if (auth()->user()->hasPermission('roles-update'))
                                                        <li><a
                                                                href="{{ route('roles.edit', $role->id) }}">@lang('edit role')</a>
                                                        </li>
                                                    @endif

                                                    @if (auth()->user()->hasPermission('roles-delete'))
                                                        <li><a
                                                                href="{{ route('roles.delete', ['id' => $role->id]) }}">@lang('delete role')</a>
                                                        </li>
                                                    @endif
                                                </ul>
                                            </div> --}}
