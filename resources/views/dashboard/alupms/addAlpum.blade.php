...
@section('content')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0 text-primary">@lang('Add new alpum')</h4>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ route('alpums.store') }}"
                        enctype="multipart/form-data">
                        @csrf

                        <div class="form-group row">
                            <label for="inputName" class="col-md-2 form-label">@lang('Alpum Title')</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            <label for="inputName" class="col-md-2 form-label">@lang('Alpum Cover Image')</label>
                        ...
                        <div class="form-group row">
                            <label for="inputName" class="col-md-2 form-label">@lang('Alpum Images')</label>
                            <div class="col-lg-4 col-sm-12">
                                <input type="file" name="images[]" class="dropify"
                                    accept="image/png, image/gif, image/jpeg"
                                    data-default-file="http://azea.test/assets/images/photos/media1.jpg" data-height="180"
                                    multiple />
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-0 mt-2 row justify-content-end">
                            <div class="col-md-9">
                                ...
                                <a class="btn btn-danger" href="{{ route('alpums.index') }}"
